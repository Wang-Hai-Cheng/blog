/** Created By wang-hai-cheng https://wang-hai-cheng.me
 * mail to wang-hai-chengwork@163.com
...
var template = {
    footer:
        ...
        '                <a href="https://shop68701876.taobao.com/?spm=a211vu.server-home.sellercard.15.57305e162glUW4" target="_blank" style="color: #1E9FFF;">楠斯素材</a>' +
        '           </p>' +
        '       </div>' +
        '   </div> ' +
        '</div>'
    ...
    bottomNav: '' +
        ...
        '                    <p style="padding-bottom: 5px;">个人博客（NoteLofter）：是专门为 Java 程序员提供的一套开源的笔记/博客平台，同时也可作为初学者的上手学习项目。</p>' +
