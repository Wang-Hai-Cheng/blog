...
public class SqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        String packageName = "D:/workspace/git-workspace/noteblogv4-master/src/main/java/me/wang-hai-cheng/noteblogv4/model/entity";
        //生成sql的文件夹
        String filePath = "D:/workspace/";
        //项目中实体类的路径
        String prefix = "me.wang-hai-cheng.noteblogv4.model.entity.";
        String className = "";
