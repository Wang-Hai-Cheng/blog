...
import com.blog.service.users.UsersService;
...
import static com.blog.config.permission.NBAuth.Group;

/**
 * created by wang-hai-cheng on 2018/7/28 at 23:37
 *
...
public class UserController extends BaseController {
    ...
    @RequestMapping
    @NBAuth(value = "management:user:router", remark = "用户管理界面", type = NBSysResource.ResType.NAV_LINK, group = Group.ROUTER)
