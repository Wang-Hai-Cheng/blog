...
import com.blog.dao.repository.CloudFileCateRepository;
import com.blog.dao.repository.CloudFileRepository;
import com.blog.exception.NoteFetchFailedException;
...
/**
 * created by wang-hai-cheng on 2018/8/18 at 10:14
 *
...
public class CloudFileController extends BaseController {
    ...
    @NBAuth(value = "management:cloudFile:list_page", remark = "云文件管理页面", type = NBSysResource.ResType.NAV_LINK, group = NBAuth.Group.ROUTER)
    public String list() {
        return "management/cloud/cloud_file_list";
    }

    @RequestMapping("/add")
    @NBAuth(value = "management:cloudFile:add_page", remark = "云文件发布页面", type = NBSysResource.ResType.NAV_LINK, group = NBAuth.Group.ROUTER)
    ...
    @RequestMapping("/edit")
    @NBAuth(value = "management:cloudFile:edit_page", remark = "云文件管编辑页面", type = NBSysResource.ResType.OTHER, group = NBAuth.Group.ROUTER)
    ...
    @NBAuth(value = "management:cloudFile:list_data", remark = "云文件管理页面中的数据接口", group = NBAuth.Group.AJAX)
    @ResponseBody
    ...
    @NBAuth(value = "management:cloudFile:create", remark = "发布一个新的项目", group = NBAuth.Group.AJAX)
    @ResponseBody
    ...
    @NBAuth(value = "management:cloudFile:update", remark = "修改一个云文件", group = NBAuth.Group.AJAX)
    @ResponseBody
    ...
    @ResponseBody
    @NBAuth(value = "management:cloudFile:delete", remark = "删除云文件操作", group = NBAuth.Group.AJAX)
