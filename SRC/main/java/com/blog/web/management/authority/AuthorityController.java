package com.blog.web.management.authority;
...
import com.blog.config.permission.NBAuth.Group;
import com.blog.dao.repository.MenuRepository;
import com.blog.dao.repository.ResourceRepository;
import com.blog.dao.repository.RoleRepository;
import com.blog.dao.repository.RoleResourceRepository;
...
/**
 * created by wang-hai-cheng on 2018/7/23 at 10:50
 *
...
public class AuthorityController extends BaseController {
    ...
    @RequestMapping("/role")
    @NBAuth(value = "permission:role:router", remark = "后台角色管理页面", type = NBSysResource.ResType.NAV_LINK, group = Group.ROUTER)
    ...
    @RequestMapping("/menu")
    @NBAuth(value = "permission:menu:router", remark = "菜单管理页面", type = NBSysResource.ResType.NAV_LINK, group = Group.ROUTER)
