package com.blog.web.management.settings;
...
import com.blog.service.settings.SettingsService;
...
import static com.blog.model.constant.NoteBlogV4.Session.SESSION_ID_COOKIE;

/**
 * created by wang-hai-cheng on 2018/8/11 at 16:14
 *
...
public class SettingsController extends BaseController {
    ...
    @NBAuth(value = "management:settings:common", remark = "网站基本设置界面", group = ROUTER, type = NBSysResource.ResType.NAV_LINK)
    ...
    @NBAuth(value = "management:settings:theme", remark = "网站风格设置界面", group = ROUTER, type = NBSysResource.ResType.NAV_LINK)
    ...
    @NBAuth(value = "management:settings:mail", remark = "网站发送邮件服务器设置", group = ROUTER, type = NBSysResource.ResType.NAV_LINK)
    ...
    @NBAuth(value = "management:settings:profile", remark = "管理员个人信息设置", group = ROUTER, type = NBSysResource.ResType.NAV_LINK)
    ...
    @NBAuth(value = "management:settings:qrcode", remark = "微信和支付宝二维码图片设置界面", group = ROUTER, type = NBSysResource.ResType.NAV_LINK)
