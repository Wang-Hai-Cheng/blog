package com.blog.web.management.content;
...
import com.blog.service.content.ArticleService;
import com.blog.service.content.TagService;
...
/**
 * created by wang-hai-cheng on 2018/8/2 at 21:24
 *
...
public class ArticleController extends BaseController {
    ...
    @NBAuth(value = "management:article:post_page", remark = "博文发布页面", type = NBSysResource.ResType.NAV_LINK, group = ROUTER)
    ...
    @NBAuth(value = "management:article:list_page", remark = "博文管理页面", type = NBSysResource.ResType.NAV_LINK, group = ROUTER)
    public String articleList() {
        return "management/content/article_list";
    }

    @RequestMapping("/article/edit")
    @NBAuth(value = "management:article:edit_page", remark = "博文管编辑页面", type = NBSysResource.ResType.OTHER, group = ROUTER)
    ...
    @ResponseBody
    @NBAuth(value = "management:article:edit_article_tags", remark = "编辑文章页面的tag数据包含选中的(selected)", type = NBSysResource.ResType.OTHER, group = AJAX)
