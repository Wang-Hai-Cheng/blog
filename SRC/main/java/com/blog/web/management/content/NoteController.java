...
public class NoteController extends BaseController {
    ...
    @NBAuth(value = "management:note:list_page", remark = "随笔管理页面", type = NBSysResource.ResType.NAV_LINK, group = ROUTER)
    public String noteList() {
        return "management/content/note_list";
    }

    @RequestMapping("/post")
    @NBAuth(value = "management:note:post_page", remark = "随笔/笔记发布页面", type = NBSysResource.ResType.NAV_LINK, group = ROUTER)
    public String notePost() {
        return "management/content/note_post";
    }

    @RequestMapping("/edit")
    @NBAuth(value = "management:note:edit_page", remark = "随笔管编辑页面", type = NBSysResource.ResType.OTHER, group = ROUTER)
    ...
    @ResponseBody
    @NBAuth(value = "management:note:edit_note_tags", remark = "编辑随笔/笔记页面的tag数据包含选中的(selected)", type = NBSysResource.ResType.OTHER, group = AJAX)
