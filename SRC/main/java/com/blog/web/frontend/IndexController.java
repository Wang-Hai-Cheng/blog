...
/**
 * created by wang-hai-cheng on 2018/7/31 at 21:33
 *
    ...
    public String index(Model model) {
        ...
        return handleStyle(
                ...
                () -> {
                    ...
                    model.addAttribute("settings", paramRepository);
                    if (NoteBlogV4.ParamValue.PAGE_MODERN_DEFAULT.equalsIgnoreCase(pageModern)) {
                        return "frontend/index/index_flow";
                    } else if (NoteBlogV4.ParamValue.PAGE_MODERN_BUTTON.equalsIgnoreCase(pageModern)) {
