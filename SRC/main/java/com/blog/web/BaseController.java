...
/**
 * created by wang-hai-cheng on 2018/7/17 at 17:09
 *
...
public abstract class BaseController {
    ...
    protected static String handleStyle(String simple, Supplier<String> normalOrOther, ParamRepository paramRepository) {
        ...
        if (StringUtils.isEmpty(style)) {
            ...
            if (NoteBlogV4.ParamValue.STYLE_SIMPLE.equalsIgnoreCase(style)) {
                return simple;
            } else if (NoteBlogV4.ParamValue.STYLE_NORMAL.equalsIgnoreCase(style)) {
