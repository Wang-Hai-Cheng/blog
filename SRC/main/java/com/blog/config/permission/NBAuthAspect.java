package com.blog.config.permission;
...
import com.blog.exception.UnauthorizedRoleException;
 ...
 * created by wang-hai-cheng on 2018/7/18 at 15:50
 *
...
public class NBAuthAspect extends BaseController {
     ...
     * 权限验证切点
     */
    @Pointcut("@annotation(com.blog.config.permission.NBAuth)")
     ...
     * 角色验证切点
     */
    @Pointcut("@annotation(com.blog.config.permission.NBAuthRole)")
