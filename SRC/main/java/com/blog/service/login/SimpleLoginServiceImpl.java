...
import com.blog.model.pojo.business.SimpleLoginData;
...
import static com.blog.model.pojo.framework.NBR.error;
import static com.blog.model.pojo.framework.NBR.ok;

/**
 * 普通登录方法
 * created by wang-hai-cheng on 2018/7/21 at 18:05
...
public class SimpleLoginServiceImpl implements LoginService<SimpleLoginData> {
    ...
    public NBR doLogin(SimpleLoginData data) {
        ...
        if (findUser != null) {
            ...
            return NBR.ok("登陆成功！", redirectUrl);
        } else {
            return NBR.error("用户名或密码错误！");
        }
