...
import com.blog.model.pojo.business.QqLoginModel;
...
/**
 * created by wang-hai-cheng on 2018/1/23 at 12:33
    ...
    public NBR doLogin(QqLoginModel model) {
        try {
            ...
            if (json2.getInt("ret") == 0) {
                ...
                if (user != null) {
                    return NBR.ok("授权成功！", "/").put(NoteBlogV4.Session.LOGIN_USER, user);
                } else {
